...
│   └── Settings/    SettingsView (root), ProviderSettingsView (+ RegionPickerView), SharingSettingsView, LegacyImportView, SyncActivityView (About → iCloud Sync: log, Check, Repair, Reset, Copy Core Data Log)
├── Services/
