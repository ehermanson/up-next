...
│   └── ActivityEvent.swift        Shared activity log entry (kind/title/mediaKey/contextName/actorName) on the root; sentence(actor:)
├── ViewModels/
